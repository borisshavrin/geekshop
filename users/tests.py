...
class TestUserManagement(TestCase):
    def setUp(self):
        ...
        self.superuser = User.objects.create_superuser('django2', 'django2@geekshop.local', '123')

        self.user = User.objects.create_user('tarantino', 'tarantino@geekshop.local', '123')
